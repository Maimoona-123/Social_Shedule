  ...
  return (
    <div className='space-y-8'>
      ...
      <div>
        ...
        <p className='text-slate-600 text-sm mt-0.5'>Here's what's happening with ur social accounts today..</p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5'>
        {statsCards.map((card) => (
          <div key={card.label} className='bg-white hover:bg-red-50 relative border border-slate-500 rounded-2xl p-5
        ...
        {activities.length === 0 ? (
          ...
          <div className='divide-y divide-slate-50'>
            {activities.map((activity) => (
              <div key={activity._id} className='px-6 py-4 flex items-center gap-4 hover:bg-slate-50/50 transition-colors'>
                <div className='size-9 rounded-xl flex items-center justify-center shrink-0 mt-0.5 bg-zinc-100 text-zinc-500'>
